...
public class SocketDataBase {
    ...
    public static String getHandshakeData() {
        ...
        try {
            ...
            jsonObject1.put("id", BaseApplication.getUserId());
...
//            jsonObject.put("data",jsonObject1);
    ...
    public static String editNetwork(int dhcp, String ssid, String pwd, String ip, String maskCode, String gateway, int restart) {

        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("type", "editNetwork");
            JSONObject jsonObjectWifi = new JSONObject();
            ...
            jsonObject.put("wifi", jsonObjectWifi);

            jsonObject.put("restart", restart);
